<footer class="bg-dark footer-sticky pt-6">
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-lg-3 mb-5 d-flex align-items-center">
			...
			<div class="col-md-6 col-lg-3 mb-5">
				...
				<p class="text-white mb-2">Office (HQ)</p>
				<address class="mb-0">43 Tombia Street, GRA Phase 2, Port Harcourt.</address>
				<p>Call: <a href="#" class="text-body"><u>+234 810-760-1636</u> (Call/Whatsapp)</a> </p>
                
				<p class="text-white mb-2">Shop Address</p>
				<address class="mb-0">Port Harcourt Airport.</address>
				<p>Call: <a href="#" class="text-body"><u>+234 810-760-1636</u> (Call/Whatsapp)</a> </p>
			</div>
		...
		<div class="row align-items-center justify-content-md-between py-4">
			<div class="col-12 mx-auto">
				<div class="text-center">© <script>document.write(new Date().getFullYear());</script> Eritage Africa&trade;. All rights reserved || Built by <a href="https://www.webify.com.ng" target="_blank">Webify</a>
				</div>
			</div>
		</div>
	</div>
