...
<main>
    ...
    <section class="bg-parallax bg-dark-overlay-4 pt-8 pt-md-10 pb-6 pb-md-8" style="background:url(assets/images/founder-bg.jpg) no-repeat center center; background-size:cover;">
        <figure class="position-absolute end-0 bottom-0 mb-n8 me-8 d-none d-lg-block">
        ...
        <div class="container">
            <div class="row d-flex justify-content-lg-between">
                <div class="col-md-7">
                    <h1 class="display-6 text-white"><span class="text-white-stroke">FOUNDER</span> Statement.</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row d-flex justify-content-lg-between align-items-center">
                <div class="col-lg-5">
                    <div class="reveal-item bg-light rounded" data-aos="reveal-item">
                        ...
                        <img class="w-100" src="assets/images/pamela.jpeg" alt="Portfolio image">
                    </div>
                    <span class="font-alt fw-normal display-8 bg-primary text-white float-end d-inline-block mt-n5 me-lg-n5 px-3 rotate-10">Tamunotonye Pamela</span>
                </div>

                <div class="col-lg-6 mt-5 mt-lg-0 mt-xl-5">
                    <span class="font-alt fw-normal display-8 d-block mb-3">Our Founder's Statement</span>
                    <p class="lead">We are dedicated to upholding humanity and preserving its essence. Our focus on promoting peace and development in the Niger Delta region drives us to prioritize initiatives in tourism, culture, and humanitarian efforts to cultivate sustainable prosperity. We are actively seeking partners who share our vision and are willing to collaborate on ambitious projects that push boundaries, whether they are nonprofit or commissioned. Our team is committed to delivering outstanding work as excellence is the hallmark of our agency.</p>
                    <span class="font-alt fw-normal display-8 d-block mb-3 text-danger">Tamunotonye Pamela (Founder/Creative Director)</span>
                    <div class="animate__animated animate__fadeInUp mt-4 animate__delay-2s"><a href="about" class="btn btn-primary btn-lg btn-line">Learn more about us</a></div>
                </div>
            </div>
        </div>
    </section>
